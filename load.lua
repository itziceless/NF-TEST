...
local UILib = loadstring(game:HttpGet("https://raw.githubusercontent.com/itziceless/NF-TEST/refs/heads/main/ui.lua",  true))() -- adjust path if UILibrary.lua lives elsewhere
